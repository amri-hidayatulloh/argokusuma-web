    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
              ...
              <li class="treeview <?php echo $this->router->class=='pricing' ? 'active' : ''; ?>">
                <a href="<?php echo site_url('webtools/pricing'); ?>">
                  <i class="fa fa-dollar"></i>
                  <span>Pricings</span>
                  <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li class="<?php echo $this->router->class=='pricing' && $this->router->method=='index'  ? 'active' : ''; ?>">
                    <a href="<?php echo site_url('webtools/pricing'); ?>"><i class="fa fa-circle-o"></i> List Pricings</a>
                  </li>
                  <li class="<?php echo $this->router->class=='pricing' && $this->router->method=='action'  ? 'active' : ''; ?>">
                    <a href="<?php echo site_url('webtools/pricing/action/add'); ?>"><i class="fa fa-circle-o"></i> Add Pricing</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="treeview <?php echo $this->router->class=='submission' ? 'active' : ''; ?>">
                ...
                <ul class="treeview-menu">
                  ...
                  <li class="<?php echo $this->router->class=='submission' && $this->router->method=='suggestion'  ? 'active' : ''; ?>">
                    <a href="<?php echo site_url('webtools/submission/suggestion'); ?>"><i class="fa fa-circle-o"></i> Suggestions</a>
                  </li>
                </ul>
              </li>

              <li class="treeview <?php echo $this->router->class=='consultation' ? 'active' : ''; ?>">
                <a href="<?php echo site_url('webtools/consultation'); ?>">
                  <i class="fa fa-phone"></i>
                  <span>Consultation</span>
                  <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li class="<?php echo $this->router->class=='consultation' && $this->router->method=='index'  ? 'active' : ''; ?>">
                    <a href="<?php echo site_url('webtools/consultation'); ?>"><i class="fa fa-circle-o"></i> Customer Care</a>
                  </li>
                  <li class="<?php echo $this->router->class=='consultation' && $this->router->method=='contact'  ? 'active' : ''; ?>">
                    <a href="<?php echo site_url('webtools/consultation/contact'); ?>"><i class="fa fa-circle-o"></i> Contact Informations</a>
                  </li>
                </ul>
              </li>

              <li class="<?php echo $this->router->class=='jobs' ? 'active' : ''; ?>">
                <a href="<?php echo site_url('webtools/jobs'); ?>">
                  <i class="fa fa-briefcase"></i> <span>Job Vancancies</span>
                </a>
              </li>
              ...
              <li class="treeview <?php echo $this->router->class=='settings' ? 'active' : ''; ?>">
                ...
                <ul class="treeview-menu">
                  ...
                  <li class="<?php echo $this->router->class=='settings' && $setting_current=='blog'  ? 'active' : ''; ?>">
                    <a href="<?php echo site_url('webtools/settings/index/blog'); ?>"><i class="fa fa-circle-o"></i> Blog</a>
                  </li>

                  <li class="<?php echo $this->router->class=='settings' && $setting_current=='pricing'  ? 'active' : ''; ?>">
                    <a href="<?php echo site_url('webtools/settings/index/pricing'); ?>"><i class="fa fa-circle-o"></i> Pricing</a>
                  </li>

                  <li class="<?php echo $this->router->class=='settings' && $setting_current=='suggestions'  ? 'active' : ''; ?>">
                    <a href="<?php echo site_url('webtools/settings/index/suggestions'); ?>"><i class="fa fa-circle-o"></i> Suggestion Page</a>
                  </li>

                  <li class="<?php echo $this->router->class=='settings' && $setting_current=='consultation'  ? 'active' : ''; ?>">
                    <a href="<?php echo site_url('webtools/settings/index/consultation'); ?>"><i class="fa fa-circle-o"></i> Consultation</a>
                  </li>
                </ul>
              </li>
