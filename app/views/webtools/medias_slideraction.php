<div class="col-xs-12">
		<div class="box box-danger">
            <form role="form" method="POST" action="<?php echo site_url('webtools/medias/save_slide'); ?>" id="ajax-form-file" enctype="multipart/form-data">
                  ...
                  <?php render_tab_text('Title','title',(!isset($slide) ? '' : $slide->title),['type'=>'slider','item'=>'title','ref'=>(isset($slide) ? $slide->id : 0)],'',100); ?>

                  <?php render_tab_text('Description','caption',(!isset($slide) ? '' : $slide->caption),['type'=>'slider','item'=>'caption','ref'=>(isset($slide) ? $slide->id : 0)],'',255); ?>

                  <?php render_tab_text('Button Text','linktext',(!isset($slide) ? '' : $slide->link_text),['type'=>'slider','item'=>'linktext','ref'=>(isset($slide) ? $slide->id : 0)],'',100); ?>
