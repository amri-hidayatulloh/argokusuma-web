		  ...
		  <div class="form-group">
            <fieldset>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" <?php if($i == 0) echo 'class="active"'; ?>><a href="#<?php echo $value['option_key'].$b['keylang']; ?>" aria-controls="<?php echo $value['option_key'].$b['keylang']; ?>" role="tab" data-toggle="tab"><?php echo $b['label']; ?></a></li>
                    <?php $i++; endforeach; ?>
                </ul>
                <div class="tab-content">
                    <?php $i = 0; foreach($languages as $a => $b): ?>
                    <div role="tabpanel" class="tab-pane <?php if($i == 0) echo 'active'; ?>" id="<?php echo $value['option_key'].$b['keylang']; ?>">
                    	<input type="text" class="form-control" id="field<?php echo $value['option_key'].$b['keylang']; ?>" placeholder="" name="<?php echo $value['option_key'].'['.$b['keylang'].']'; ?>" value="<?php echo isset($text[$b['keylang']]) ? $text[$b['keylang']] : $value['option_value']; ?>" <?php if($value['editable'] == 0) echo 'disabled'; ?>>
		   ...
		   <div class="form-group">
            <fieldset>
                ...
                <div class="tab-content">
                    <?php $i = 0; foreach($languages as $a => $b): ?>
                    <div role="tabpanel" class="tab-pane <?php if($i == 0) echo 'active'; ?>" id="<?php echo $value['option_key'].$b['keylang']; ?>">
                        <textarea class="form-control" name="<?php echo $value['option_key'].'['.$b['keylang'].']'; ?>" id="field<?php echo $value['id'].$b['keylang']; ?>" placeholder=""  <?php if($value['editable'] == 0) echo 'disabled'; ?> rows="3"><?php echo isset($text[$b['keylang']]) ? $text[$b['keylang']] : $value['option_value']; ?></textarea>
			  			<p class="help-block"><?php echo $value['desclimer']; ?></p>
                    </div>
                    <?php $i++; endforeach; ?>
                </div>         
