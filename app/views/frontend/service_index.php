<div class="container-fluid cover-area" style="background: url(<?php echo site_url('assets/static/'.get_option('service-cover')); ?>);">
	<div class="overlay"></div>
	<div class="row">
		<div class="col-10 text-left">
			<span class="text-shadow"><?php echo get_option_lang('service-title'); ?></span>
			<h1 class="text-shadow"><?php echo get_option_lang('service-sub-title'); ?></h1>
		</div>
	</div>
</div>
...
<div class="container-fluid">
	<div class="row justify-content-md-center">
		<div class="col-11 blue-container smaller white common-section text-center">
			<span class="sub"><?php echo get_option_lang('service-title'); ?></span>
			<h1><?php echo get_option_lang('service-highlight-title'); ?></h1>
			<p><?php echo get_option_lang('service-highlight-body'); ?></p>
			<div class="row">
				<?php $i = 1; foreach ($services as $key => $value) { ?>
				<div class="col text-center">
					<a href="<?php echo site_url($selected_lang.'/what-we-do/'.$value['slug']); ?>">
						<div class="icon-area">
...
<div class="container-fluid common-section center-section-service">
	<div class="row justify-content-md-center no-padding">
		<div class="col-6 text">
			<span class="sub"><?php echo get_option_lang('service-middle-sub-title'); ?></span><br>
			<h1><?php echo get_option_lang('service-middle-title'); ?></h1>
			<p><?php echo get_option_lang('service-middle-body'); ?></p>
