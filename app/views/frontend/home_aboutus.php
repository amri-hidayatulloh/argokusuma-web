<div class="container-fluid cover-area" style="background: url(<?php echo site_url('assets/static/'.get_option('aboutus-cover')); ?>);">
	...
	<div class="row">
		<div class="col-10 text-left">
			<span class="text-shadow"><?php echo get_option_lang('about-title'); ?></span>
			<h1 class="text-shadow"><?php echo get_option_lang('about-sub-title'); ?></h1>
		</div>
	</div>
</div>
		...
		<div class="col-11">
			<div class="row about-headline about">
				<div class="col no-border">
					<span><?php echo get_option_lang('aboutus-headline'); ?></span>
					<h1><?php echo get_option_lang('aboutus-headline-heading'); ?></h1>
					<p><?php echo get_option_lang('aboutus-headline-body'); ?></p>
			...
			<div class="row stat-area">
				<div class="col text-center">
					<div class="counter-area">
						...
						<span class="counter" data-max="<?php echo get_option_lang('stat-value-1'); ?>"><?php echo get_option_lang('stat-value-1'); ?></span>
					</div>
				...
				<div class="col text-center">
					<div class="counter-area">
						...
						<span class="counter" data-max="<?php echo get_option_lang('stat-value-2'); ?>"><?php echo get_option_lang('stat-value-1'); ?></span>
					</div>
				...
				<div class="col text-center">
					<div class="counter-area">
						...
						<span class="counter" data-max="<?php echo get_option_lang('stat-value-3'); ?>"><?php echo get_option_lang('stat-value-1'); ?></span>
					</div>
...
<div class="vision">
	...
	<div class="text-area">
		<div class="container-fluid">
			<div class="row justify-content-md-center">
				<div class="col-5">
					<span class="number"><?php echo get_option_lang('aboutus-mission-number'); ?></span>
					<h2><?php echo get_option_lang('aboutus-mission-title'); ?></h2>
					<p><?php echo get_option_lang('aboutus-mission-body'); ?></p>
				</div>
				<div class="col-5">
					<span class="number"><?php echo get_option_lang('aboutus-vission-number'); ?></span>
					<h2><?php echo get_option_lang('aboutus-vission-title'); ?></h2>
					<p><?php echo get_option_lang('aboutus-vission-body'); ?></p>
				</div>
			</div>
		</div>
	</div>
