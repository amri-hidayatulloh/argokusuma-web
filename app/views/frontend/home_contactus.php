<div class="container-fluid cover-area" style="background: url(<?php echo site_url('assets/static/'.get_option('contactus-cover')); ?>);">
	...
	<div class="row">
		<div class="col-10 text-left">
			<span class="text-shadow"><?php echo get_option_lang('get-in-touch'); ?></span>
			<h1 class="text-shadow"><?php echo get_option_lang('contact-us'); ?></h1>
		</div>
	</div>
</div>
			...
			<div class="row">
				<div class="col text-center">
					<div class="group">
						...
						<div class="text-area">
							<h1><?php echo get_option_lang('location'); ?></h1>
							<p><?php echo get_option_lang('office-address'); ?></p>
						</div>
					</div>
				...
				<div class="col text-center">
					<div class="group">
						...
						<div class="text-area">
							<h1><?php echo get_option_lang('phone-number'); ?></h1>
							<p><?php echo get_option_lang('phone-number'); ?></p>
						</div>
					</div>
				...
				<div class="col text-center">
					<div class="group">
						...
						<div class="text-area">
							<h1>E-Mail</h1>
							<p><?php echo get_option_lang('email-address'); ?></p>
						</div>
					</div>
		...
		<div class="col-11">
			<div class="row about-headline about">
				<div class="col no-border text-center">
					...
					<h1 class="center"><?php echo get_option_lang('leave-comment'); ?></h1>
				...
				<div class="col">
					<div class="map-embed">
						<iframe src="<?php echo get_option_lang('embed-map-url'); ?>" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
					</div>
				</div>
			</div>
		</div>
