...
<div class="container-fluid portfolio-container">
	<div class="row justify-content-md-center">
		<div class="col-11 category-area">
			<a href="<?php echo site_url($selected_lang.'/portfolio/index/all'); ?>" <?php if($active_category == 'all') echo 'class="active"'; ?>>All</a>
			<?php foreach ($categories as $key => $value) { ?>
			<a href="<?php echo site_url($selected_lang.'/portfolio/index/'.$value['slug']); ?>" <?php if($active_category == $value['slug']) echo 'class="active"'; ?>><?php echo $value['category']; ?></a>
			<?php } ?>
		</div>
	</div>
	<div class="row justify-content-md-center">
