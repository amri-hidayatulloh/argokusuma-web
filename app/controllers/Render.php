...
class Render extends APP_Frontend {
	...
	public function lang($group = 'lang',$field_type = 'text') {
		if(isset($_POST['key']) and !empty($_POST['key'])) {
			...
			update_option($keys,$vals_str,array('option_group'=>$group,'field_type'=>$type,'caption'=>$caption,'multiple_langs'=>1,'editable'=>1));
		}



		$this->load->view('frontend/render_lang',['group'=>$group,'type'=>$field_type]);
	}
