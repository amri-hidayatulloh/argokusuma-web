...
class Medias extends APP_Webtools {
	...
	public function save_slide() {
		...
		$linktext = $this->get_input_lang('linktext');
		...
		if(isset($save) and $save != FALSE) {
			$this->save_text('slider','title',$id,$title['lists']);
			$this->save_text('slider','caption',$id,$caption['lists']);
			$this->save_text('slider','linktext',$id,$linktext['lists']);
